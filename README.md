...
房语彩色小黑角色协同系统。一个用于固定“胶囊款 Xiaohei”彩色角色体系的 Codex Skill。

这个 Skill 用来固定“胶囊款 Xiaohei”的彩色角色体系：同一个竖向胶囊小黑，只通过低饱和身体颜色产生不同角色分工，并在真实物件场景里协同工作。

## 这个仓库是什么

这是一个面向中文内容创作和 AI 生图工作流的角色设定 Skill。

它解决的问题是：当小黑从单一黑色角色扩展成彩色角色家族时，如何避免变成“彩虹吉祥物”，而是让不同颜色自然承担不同叙事功能，并在同一张真实物件场景图里形成协同工作关系。
...
单一小黑很适合表达一个人的处境、荒诞动作和职场共鸣。但当画面要表达复杂协作、产品竞争、风险修复、系统接入、机会启动等多层语义时，单一角色容易不够用。
