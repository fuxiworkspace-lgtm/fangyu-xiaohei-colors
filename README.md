...
它把一个固定的胶囊款 Xiaohei，扩展成一支有分工、有性格、会协同的小型视觉团队：小黑推进主线，小红拉响警报，小蓝接入系统，小绿负责修复，小黄点亮机会，小灰承接疲惫与等待。
...
- 多个角色必须围绕同一个真实物件共同完成任务，而不是排排站做角色海报。
...
| 小红 | 警报、冲突、风险、情绪峰值 | 商战、限额、危机、竞争、市场波动 |
| 小绿 | 修复、稳定、信任、连接 | 故障恢复、长期陪伴、项目收束 |
| 小蓝 | 系统、工具、代码、数据 | AI 工作流、自动化、产品与技术 |
| 小黄 | 机会、提醒、启动、点亮 | 预热、报名、灵感、活动开端 |
| 小灰 | 疲惫、过渡、等待、低能量 | 卡住、复盘、不确定、漫长等待 |
| 小白 | 空状态、留白、待确认 | 未开始、空白页、等待输入 |

颜色是叙事功能，不是装饰。没有明确工作，就不让角色出场。
...
Skill 会完成内容提炼、颜色路由、角色分工、真实物件隐喻、协同动作和生图提示词设计。
