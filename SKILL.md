...
进一步判断角色当前的张力状态：低张力、中张力、高张力或收束状态。张力通过姿态、线缆、桥、容器、门、纸张等真实物件表现，不通过夸张表情表现。读取 `references/role-system.md` 的“角色张力状态”和“场景张力模板”。
...
动作还要体现当前张力：低张力用观察、等待、轻触和准备；中张力用推进、调试、拉扯和承接；高张力用绷紧、阻挡、抢救、过载和突破；收束用修复、交接、放下、重置或继续前进。
